...
# The Challenge
The goal of this project was to analyze patient data to identify key drivers of 30 day hospital readmissions.High readmission rates affect both patient outcome and financial cost.
